...
<script type='text/javascript'>
    ...
    const speakout = new SpeechSynthesisUtterance(
        'What\'s the number that you want to collect money from?'
    );
            ...
            setTimeout(function() {
                ...
                setTimeout( function() {
                    const amountSpeakOut = new SpeechSynthesisUtterance(
                        'How much do you wish to collect?'
                    );
                    amountSpeakOut.rate = 1.0;
                                ...
                                amountRecognition.onend = function() {
                                    ...
                                    setTimeout( function() {
                                        ...
                                        console.log(ns_amt);
                                            ...
                                            formData.append('s_amount', ns_amt);
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(data) {
                                                    ...
                                                    const successSpeakOut = new SpeechSynthesisUtterance(
                                                        'Money pull or collection request sent, the person will be required to input their pin to complete the transaction.'
                                                    );
                                                    successSpeakOut.rate = 1.0;
                                                    speechSynthesis.speak(successSpeakOut);

                                                },
                                                error: function(data) {
                                                    console.log('Error:', data);
                                                    const errorSpeakOut = new SpeechSynthesisUtterance(
                                                        'Sorry, the System encountered an error ... Refresh the page the try again!'
                                                    );
                                                    errorSpeakOut.rate = 1.0;
                                                    speechSynthesis.speak(errorSpeakOut);
                                                }
                                            });
