        ...
        speakout.onend = function() {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    var x = document.getElementById('speechText').value;
                    if (isNaN(x)) 
                    {
                        ...
                        if ($('#status').val() == 'adding') {
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('a-activities.store') }}",
                                data: formData,
                                cache: false,
                                contentType: false,
                                processData: false,
                        ...
                        if ($('#status').val() == 'editing') {
                            ...
                            var c_url = '{{ route('a-activities.update', ':id') }}';
                            c_url = c_url.replace(':id', $('#activity_id').val());
                            $.ajax({
                                type: 'POST',
                                url: c_url,
                                data: formData,
