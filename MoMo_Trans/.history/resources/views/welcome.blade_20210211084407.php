            ...
            <div class="links">
                <form id="myForm" name="myForm" action="{{ route('paymomo') }}" class="form-outer">
                    ...
                    <div class='search_container'>
                        <!-- Search box-->
                        <input type='text' id='speechText' name="amount"> &nbsp; <input type='button' id='start'
                            value='Start' onclick='startRecording();'>
                    </div>
                    <br><br>
...
<script type='text/javascript'>
    ...
    recognition.onresult = function(event) {
        ...
        document.getElementById('speechText').value = window.saidText = ;
    }
    ...
    speakout.onend = function() {
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                var amount = parseInt(document.getElementById('speechText').value, 10);
                if (isNaN(amount)) {
                    // SendMoney();
                    $.ajaxSetup({
                        headers: {
                    ...
                    formData.append('s_amount', window.saidText);
                    ...
                    $.ajax({
                        ...
                        data: formData,
                        // data: {
                        //     amount: parseInt(document.getElementById('speechText').value, 10),
                        //     momo_number : document.getElementById('momo_number').value,
                        //     momo_amount : document.getElementById('momo_amount').value,
                        // },
                        cache: false,
                        contentType: false,
                        processData: false,
