    ...
    amountRecognition.onresult = function(event2) {
        ...
        for (var i2 = event2.resultIndex; i2 < event2.results.length; i2++) {
            if (event2.results[i2].isFinal) {
                window.saidAmount = event2.results[i2][0].transcript;
            } else {
                window.saidAmount += event2.results[i2][0].transcript;
            }
        }
                        ...
                        setTimeout(function () {
                            ...
                            setTimeout( function(){
                                amountRecognition.onend = function() {
                                    ...
                                    setTimeout( function() {
                                        var m_number = document.getElementById('speechText').value;
                                        var ns_number = document.write(m_number.replace(/\s/g, '') );
                                        var conv_number = parseFloat(ns_number);
                                        document.getElementById('momo_amount').value = text

                                        var amount = document.getElementById('momo_amount').value;
                                        ...
                                        // console.log(conv_amount);
                                            ...
                                            formData.append('s_number', conv_number);
