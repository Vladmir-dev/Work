                            ...
                            setTimeout( function(){
                                amountRecognition.onend = function() {
                                    ...
                                    setTimeout( function() {
                                        ...
                                        var ns_number = document.write(numm.replace(/\s/g, '') );
                                        var conv_number = parseFloat(ns_number, 10);
                                        console.log(conv_number);
                                            ...
                                            // formData.append('s_amount', console.log(document.getElementById('speechText').value));
                                            // formData.append('s_number', console.log(document.getElementById('momo_amount').value));
